...
const NavLink = ({ target, label, scrollToSection }) => (
  <button
...
const BrandLogo = ({ isDark = false }) => (
  <div className={`flex items-center ${isDark ? 'text-white' : 'text-slate-900'}`}>
    <img
      src={markLogo}
      alt="Shnoor International"
      className="w-[60px] h-[62px] object-cover rounded-full mr-2.5"
    />
    <div>
      <h1 className="brand-logo text-xl md:text-2xl font-semibold mb-1 tracking-tight leading-tight">
        SHNOOR International
      </h1>
      <p className={`text-xs md:text-sm font-medium tracking-[0.18em] uppercase ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>
        Learning Platform
      </p>
    </div>
  </div>
    ...
    <div className="min-h-screen bg-slate-50 font-sans selection:bg-slate-500 selection:text-white overflow-x-hidden">
      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-white/80 backdrop-blur-md shadow-sm border-b border-white/20' : 'bg-transparent'}`}>
        <div className="max-w-7xl mx-auto px-6 h-24 flex items-center justify-between">
          ...
          {/* Desktop Nav */}
          <div className="hidden md:flex items-center gap-8 glass-panel px-6 py-2 rounded-full">
            <NavLink target="home" label="Home" scrollToSection={scrollToSection} />
            <NavLink target="training" label="Training" scrollToSection={scrollToSection} />
            <NavLink target="certification" label="Certifications" scrollToSection={scrollToSection} />
            <NavLink target="stories" label="Success Stories" scrollToSection={scrollToSection} />
            <NavLink target="contact" label="Contact" scrollToSection={scrollToSection} />
          </div>
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <button onClick={onRegister} className="btn-landing-primary h-10 px-6 text-sm">
              Get Started
            </button>
          </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="hidden lg:block relative h-full min-h-[500px] perspective-[2000px]">
            ...
            <div className="absolute top-12 left-10 right-10 bg-[#1e293b] backdrop-blur-xl border border-slate-700 shadow-2xl rounded-3xl overflow-hidden transform rotate-y-[-10deg] rotate-x-[5deg] hover:rotate-0 transition-transform duration-700 ease-out z-10 font-sans">
              ...
              {/* LMS Header */}
              <div className="flex items-center justify-between px-6 py-4 bg-primary-900 border-b border-slate-700">
                ...
                <div className="flex-1 p-6 flex flex-col relative">
                  ...
                  <div className="flex-1 bg-slate-900 rounded-xl relative overflow-hidden group cursor-pointer border border-slate-700/50 shadow-2xl">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-br from-slate-800 to-slate-900 flex items-center justify-center">
                      <div className="w-full h-full opacity-20 bg-dot-pattern-light"></div>
      ...
      <section id="certification" className="py-20 px-6 bg-slate-100/50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <button onClick={onRegister} className="btn-landing-accent">
      ...
      <section className="bg-slate-900 py-16 px-6 relative overflow-hidden">
        <div className="absolute inset-0 opacity-10 bg-dot-pattern-white"></div>
      ...
      <section id="contact" className="py-24 px-6 relative z-10 bg-slate-50">
        <div className="max-w-6xl mx-auto bg-white rounded-[2rem] overflow-hidden shadow-2xl flex flex-col lg:flex-row border border-slate-100">
          ...
          {/* Left Side (Dark Info) */}
          <div className="bg-primary-900 p-12 lg:w-5/12 text-white flex flex-col justify-center relative overflow-hidden">
            <div className="absolute inset-0 opacity-10 bg-dot-pattern-dark"></div>
      ...
      {/* --- FOOTER --- */}
      <footer className="bg-primary-900 border-t border-slate-800 pt-16 pb-8 px-6 relative z-10 font-medium text-left">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 mb-16">
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li><button onClick={() => scrollToSection('training')} className="text-slate-400 hover:text-white transition-colors">Training</button></li>
        ...
        <div className="max-w-7xl mx-auto pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-slate-500">
          ...
          <div className="flex gap-6">
            <a href="#" className="hover:text-slate-300 text-slate-500">Privacy Policy</a>
            <a href="#" className="hover:text-slate-300 text-slate-500">Cookie Policy</a>
            <a href="#" className="hover:text-slate-300 text-slate-500">Company Profile</a>
          </div>
        </div>
      </footer>
    </div>
